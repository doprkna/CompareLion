 ...
 */
export function FallbackIcon({ size = 24, className = '', 'aria-label': ariaLabel, 'aria-hidden': ariaHidden, missingName, }) {
    ...
    return (<svg width={pixelSize} height={pixelSize} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={combinedStyles} {...accessibilityProps}>
      {/* Box outline */}
      ...
      {process.env.NODE_ENV === 'development' && missingName && (<text x="12" y="20" fontSize="6" textAnchor="middle" fill="currentColor" opacity="0.5">
