...
export function Button({ variant = 'primary', size = 'md', loading = false, disabled = false, leftIcon, rightIcon, children, className = '', onClick, ...props }) {
    ...
    const Spinner = () => (<Icon name="spinner" size="sm" className="animate-spin" aria-hidden="true"/>);
    return (<button type="button" className={combinedStyles} disabled={isDisabled} onClick={isDisabled ? undefined : onClick} {...props}>
