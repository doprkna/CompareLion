...
export function Textarea({ value, onChange, placeholder, disabled = false, error = false, errorMessage, rows = 4, autoResize = false, helperText, className = '', id, ...props }) {
    ...
    return (<div className="w-full">
      <textarea ref={textareaRef} id={textareaId} value={value} onChange={onChange} placeholder={placeholder} disabled={disabled} rows={autoResize ? 1 : rows} aria-invalid={error} aria-describedby={ariaDescribedBy} className={combinedStyles} {...props}/>
