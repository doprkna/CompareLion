...
export function Progress({ value, label, size = 'md', className = '', }) {
    ...
    return (<div className="w-full">
      ...
      <div className={containerStyles} role="progressbar" aria-valuenow={clampedValue} aria-valuemin={0} aria-valuemax={100} aria-label={label || 'Progress'}>
