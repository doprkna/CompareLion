 ...
 */
const gameplayDefaults: UnifiedConfig['gameplay'] = {
  xp: {
    levelMultiplier: 100,
    questionBase: 10,
    difficulty: {
 ...
 */
const uiDefaults: UnifiedConfig['ui'] = {
  timing: {
    debounce: {
      search: 300,
      input: 500,
 ...
 */
const apiDefaults: UnifiedConfig['api'] = {
  client: {
    baseURL: '/api',
 ...
 */
const platformDefaults: UnifiedConfig['platform'] = {
  redis: {
 ...
 */
const securityDefaults: UnifiedConfig['security'] = {
  auth: {
 ...
 */
const featuresDefaults: UnifiedConfig['features'] = {
 ...
 */
export const unifiedConfigDefaults: UnifiedConfig = {
