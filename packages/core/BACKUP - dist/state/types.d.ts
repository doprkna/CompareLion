 ...
 * State event types
 */
export type StateEventType = 'load' | 'success' | 'error' | 'update' | 'invalidate';
/**
 * State event payload
 */
 ...
 */
export type StoreCreator<T extends StoreState> = (set: (partial: Partial<T> | ((state: T) => Partial<T>)) => void, get: () => T) => T;
/**
