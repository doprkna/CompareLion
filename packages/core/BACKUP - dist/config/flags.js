...
const flagCacheWithTTL = new Map();
/**
 * Get cached flag value if still valid
 */
function getCachedFlag(name) {
 ...
 */
function getEnvFlagOverride(name) {
 ...
 */
export async function getFeatureFlag(name, config) {
    // Check cache first
 ...
 */
export function getFeatureFlagSync(name, config) {
    // Check cache first
    const cached = getCachedFlag(name);
    if (cached !== null) {
        return cached;
 ...
 * @returns Resolved flag value
 */
export async function evaluateFlag(name, config, context) {
 ...
 */
export function evaluateFlagSync(name, config, context) {
 ...
 */
export async function getFeatureFlags(names, config) {
    const results = {};
 ...
 */
export function getFeatureFlagsSync(names, config) {
    const results = {};
