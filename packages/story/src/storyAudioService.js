 ...
 */
export async function attachAudioToStory(userId, storyId, audioData) {
    try {
 ...
 */
export async function clearStoryAudio(userId, storyId) {
    try {
        // Verify story exists and belongs to user
        const story = await prisma.story.findUnique({
            where: { id: storyId },
 ...
 */
export async function getStoryAudio(storyId) {
    try {
        const story = await prisma.story.findUnique({
            where: { id: storyId },
            select: {
