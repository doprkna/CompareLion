 ...
 */
export async function addStoryToCollection(userId, collectionId, storyId) {
    try {
 ...
 */
export async function removeStoryFromCollection(userId, itemId) {
    try {
...
export async function getCollection(collectionId) {
    try {
        ...
        const stickerCountsMap = new Map();
        storyIds.forEach((id) => {
        ...
        // Build stories array
        const stories = collection.items.map((item) => {
