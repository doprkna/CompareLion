...
// UTILITY FUNCTIONS
// ============================================================================
async function logAudit(type, message, meta) {
...
async function seedUserAchievements(users, achievements) {
...
async function seedInventories(users, items) {
...
async function seedLeaderboards(users) {
...
async function seedReportStats(users, items, achievements) {
...
async function main() {
    ...
    try {
        ...
        console.log(-, users(varied, stats));
        for (leaderboards;;)
            ;
        ;
