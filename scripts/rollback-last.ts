...
async function main() {
  ...
  try {
    ...
    console.log('\nðŸ“‹ Step 1: Stashing uncommitted changes...');
    try {
    ...
    // 5. Revert commit
    console.log('\nðŸ“‹ Step 2: Reverting last commit...');
    exec('git reset --hard HEAD~1');
    
    // 6. Force push if needed
    if (isPushed) {
      console.log('\nðŸ“‹ Step 3: Force pushing to remote...');
    ...
    console.error('âŒ ROLLBACK FAILED');
