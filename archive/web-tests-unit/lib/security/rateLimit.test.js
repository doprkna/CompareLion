...
import { checkLoginRateLimit, checkDailyLoginRateLimit, checkSignupRateLimit, trackFailedLogin, clearFailedLogins, getIpAddress, } from '@/lib/security/rateLimit';
// Mock Redis
const mockRedis = {
    incr: vi.fn(),
    expire: vi.fn(),
...
describe('Rate Limiting', () => {
    ...
    describe('Failed Login Tracking with Redis', () => {
        ...
        it('should clear failed login attempts', async () => {
            ...
            expect(mockRedis.del).toHaveBeenCalledWith(expect.stringContaining('login_attempts:test@example.com:192.168.1.100'));
        });
    });
});
