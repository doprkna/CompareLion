...
import { XP_CONSTANTS, CURRENCY_CONSTANTS, ECONOMY_CONSTANTS, REWARD_CONSTANTS, COLOR_CONSTANTS, LIMITS_CONSTANTS, TIMING_CONSTANTS, ACHIEVEMENT_CONSTANTS, DEFAULTS, } from '@/lib/config/constants';
describe('Constants Exports', () => {
    ...
    it('should export helper functions', () => {
        ...
        const { xpToCoins, coinsToXP, getCoinReward, getPriceRange, getSeasonEndReward, } = require('@/lib/config/constants');
