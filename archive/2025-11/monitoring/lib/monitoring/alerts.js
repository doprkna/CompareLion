 ...
 */
async function sendDiscordAlert(options) {
 ...
 */
export const alertInfo = (title, message, metadata) => sendAlert({ title, message, severity: AlertSeverity.INFO, metadata });
export const alertWarning = (title, message, metadata) => sendAlert({ title, message, severity: AlertSeverity.WARNING, metadata });
export const alertCritical = (title, message, metadata) => sendAlert({ title, message, severity: AlertSeverity.CRITICAL, metadata });
