...
export default function AdminWaitlistPage() {
    ...
    return (<div className="container mx-auto px-4 py-8">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <Button onClick={exportCSV} disabled={exporting || entries.length === 0} className="bg-accent hover:bg-accent/90">
          {exporting ? (<>
      ...
      <Card>
        ...
        <CardContent>
          {entries.length === 0 ? (<div className="text-center py-8 text-subtle">
              ...
              <table className="w-full">
                ...
                <tbody>
                  {entries.map((entry) => (<tr key={entry.id} className="border-b border-border hover:bg-card/50">
                      ...
                      <td className="p-3">
                        <span className={`inline-block px-2 py-1 rounded-full text-xs font-medium ${entry.status === 'pending'
