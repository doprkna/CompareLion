...
import { Loader2, Filter, Send } from 'lucide-react';
...
export default function AdminNotificationsPage() {
    ...
    return (<div className="max-w-6xl mx-auto p-4 sm:p-6 space-y-6">
        ...
        <CardContent className="p-4">
          ...
          <div className="space-y-3">
            <div>
              ...
              <Input value={sendUserId} onChange={(e) => setSendUserId(e.target.value)} placeholder="User ID"/>
            </div>
            <div>
            ...
            <div>
              ...
              <Input value={sendBody} onChange={(e) => setSendBody(e.target.value)} placeholder="Notification body"/>
            </div>
        ...
        <CardContent className="p-4">
          <div className="flex gap-4 items-end">
            <div className="flex-1">
              ...
              <select value={filterType} onChange={(e) => setFilterType(e.target.value)} className="w-full px-3 py-2 border rounded bg-background">
            ...
            <div className="flex-1">
              ...
              <Input type="text" value={filterUserId} onChange={(e) => setFilterUserId(e.target.value)} placeholder="User ID"/>
            </div>
      ...
      <div className="space-y-2">
        {notifications.map((notification) => (<Card key={notification.id}>
            <CardContent className="p-4">
                  ...
                  <div className="flex items-start justify-between gap-2">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        {!notification.isRead && (<span className="text-xs px-2 py-1 bg-primary/20 text-primary rounded">
                            Unread
                          </span>)}
                      </div>
                      {notification.body && (<p className="text-sm text-muted-foreground mb-1">
                          {notification.body}
                        </p>)}
        ...
        {notifications.length === 0 && !loading && (<Card>
