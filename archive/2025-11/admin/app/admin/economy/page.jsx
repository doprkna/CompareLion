      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        {stats && (<>
            ...
            <Card className="bg-card border-2 border-border">
              ...
              <CardContent>
                {stats.topRichUsers.length > 0 ? (<div className="space-y-2">
                    {stats.topRichUsers.map((user, index) => (<div key={user.id} className="flex items-center justify-between p-3 bg-bg rounded border border-border">
                  ...
                  </div>) : (<p className="text-subtle text-center py-4">No users found</p>)}
              </CardContent>
            </Card>
          </>)}
      </div>
