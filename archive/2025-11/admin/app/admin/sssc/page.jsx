    ...
    return (<Toast.Provider>
      <div className="p-6 space-y-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="px-3 py-1 bg-green-600 text-white rounded" onClick={handleBatchGenerate}>
        ...
        <table className="w-full text-sm border-collapse">
          ...
          <tbody>
            {filtered.map(e => (<tr key={e.id} className="border-b">
...
function ProgressWidget() {
    ...
    return (<div className="border p-4 rounded mb-4">
...
function MetricsWidget() {
    ...
    return (<div className="border p-4 rounded mb-4 grid grid-cols-4 gap-4">
