    ...
    return (<div className="min-h-screen bg-gray-900 p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-gray-800 rounded-lg p-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input type="number" value={rewardXp} onChange={(e) => setRewardXp(parseInt(e.target.value) || 20)} className="w-full px-4 py-2 bg-gray-700 text-white rounded"/>
            </div>
            <div>
              <label className="block text-sm text-gray-400 mb-2">Gold Reward</label>
              <input type="number" value={rewardGold} onChange={(e) => setRewardGold(parseInt(e.target.value) || 10)} className="w-full px-4 py-2 bg-gray-700 text-white rounded"/>
            </div>
          </div>
        ...
        <div className="bg-gray-800 rounded-lg p-6">
          ...
          {loading ? (<div className="text-gray-400">Loading...</div>) : logs.length === 0 ? (<div className="text-gray-400">No logs yet</div>) : (<div className="overflow-x-auto">
              <table className="w-full text-left">
                ...
                <tbody>
                  {logs.map((log) => (<tr key={log.id} className="border-b border-gray-700">
