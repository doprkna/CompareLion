      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <Card className="bg-card border-border text-text">
          ...
          <CardContent className="space-y-2">
            {['xs', 'sm', 'base', 'md', 'lg', 'xl', '2xl'].map((size) => (<div key={size} className="flex items-center gap-4">
        ...
        <Card className="bg-card border-border text-text">
          ...
          <CardContent>
            <div className="grid grid-cols-3 md:grid-cols-4 gap-4">
              {['sm', 'base', 'md', 'lg', 'xl', '2xl', 'full'].map((radius) => (<div key={radius} className="text-center">
        ...
        <Card className="bg-card border-border text-text">
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              {['sm', 'base', 'md', 'lg', 'xl', '2xl'].map((shadow) => (<div key={shadow} className={`h-24 bg-card border border-border rounded-lg flex items-center justify-center shadow-${shadow}`}>
