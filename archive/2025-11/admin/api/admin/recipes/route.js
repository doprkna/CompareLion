...
export const POST = safeAsync(async (req) => {
    ...
    const { name, description, outputItemId, ingredients, craftTime, skillRequirement, unlockLevel, goldCost, } = validation.data;
    ...
    try {
        const recipe = await prisma.recipe.create({
            data: {
                ...
                description,
                outputItemId,
                ingredients: ingredients, // JSON field
        ...
        return validationError(error instanceof Error ? error.message : 'Failed to create recipe');
    }
});
