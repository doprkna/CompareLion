...
export const GET = safeAsync(async (req) => {
    ...
    const [users, questions, flowQuestions, questionGenerations, achievements, items, messages, notifications, activities, auditLogs,] = await Promise.all([
        prisma.user.count(),
    ...
    if (questions === 0 && flowQuestions === 0)
