...
import { safeAsync, unauthorizedError, forbiddenError, notFoundError, validationError, successResponse, } from '@/lib/api-handler';
import { z } from 'zod';
...
export const PATCH = safeAsync(async (req, { params }) => {
    ...
    if (parsed.data.rarity !== undefined)
        updates.rarity = parsed.data.rarity;
    if (parsed.data.unlockType !== undefined)
        updates.unlockType = parsed.data.unlockType;
