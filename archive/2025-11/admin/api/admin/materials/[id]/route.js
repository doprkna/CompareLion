...
export const PUT = safeAsync(async (req, { params }) => {
    ...
    try {
        ...
        return validationError(error instanceof Error ? error.message : 'Failed to update material');
    }
});
/**
...
export const DELETE = safeAsync(async (req, { params }) => {
    ...
    try {
        ...
        return validationError(error instanceof Error ? error.message : 'Failed to delete material');
    }
});
