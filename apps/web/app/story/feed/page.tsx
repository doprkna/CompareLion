      ...
      <div className="min-h-screen bg-bg p-4">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-center py-12">
            <Icon name="spinner" className="w-8 h-8 animate-spin text-subtle" />
          </div>
        </div>
      </div>
    );
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1 min-w-0 relative">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      {story.remixMetadata && (
                        <Badge variant="outline" className="text-xs bg-purple-50 text-purple-700">
                          <Icon name="repeat" className="w-3 h-3 mr-1" size="md" />
                      ...
                      {(story.audioType && story.audioType !== 'none') && (
                        <Badge variant="outline" className="text-xs bg-green-50 text-green-700">
                          <Icon name="volume" className="w-3 h-3 mr-1" />
                          Audio
                        </Badge>
                      )}
                        ...
                        if (hoursAgo < 48) {
                          return (
                            <Badge variant="outline" className="text-xs bg-orange-50 text-orange-700">
                              <Icon name="level-up" className="w-3 h-3 mr-1" />
                              Trending
                            </Badge>
                          );
                        }
                    ...
                    <div className="flex items-center gap-4 mt-3 relative">
                      ...
                      >
                        <Icon name="repeat" className="w-4 h-4" size="md" />
                      </Button>
                      <Button
                        variant="ghost"
                        size="sm"
                      ...
                      <Button
                        ...
                        disabled={reacting.has(story.id)}
                      >
                        <Icon name="laugh" className="w-4 h-4 mr-1" size="md" />
                      ...
                      <Button
                        ...
                        disabled={reacting.has(story.id)}
                      >
                        <Icon name="xp" className="w-4 h-4 mr-1" />
