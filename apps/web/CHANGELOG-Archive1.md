...
### Fixed
  ...
  - Package exports: @parel/types (./onboarding, ./question), @parel/core (./config/flags, musicThemes, generator); @parel/story stubs for web build resolution
  - Syntax/encoding: mixed-quote imports in apps/web; invalid UTF-8 in app/play/page.tsx
