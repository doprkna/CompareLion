...
async function simulateGoogleSearch(title, description) {
    // Simulate API delay
...
async function simulateWebScrape(title) {
...
async function simulateDocSummary(description) {
...
async function simulateCustomAction(title, description) {
...
async function simulateDefaultAction(title, description) {
    await new Promise(resolve => setTimeout(resolve, 1000));
    return {
        action: 'DEFAULT',
